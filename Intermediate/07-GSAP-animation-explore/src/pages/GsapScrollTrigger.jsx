  ...
  return (
    <main>
      ...
      <div className="flex flex-col justify-center items-center w-full h-[70vh]">
        <p className="text-gray-500 text-center">Scroll down to see the animation</p>
      ...
      <div className="mt-20 w-full h-screen" ref={scrollRef}>
        <div id="scroll-pink" className="bg-pink-500 rounded-lg w-20 h-20 scroll-box" />
        <div id="scroll-orange" className="bg-orange-500 rounded-lg w-20 h-20 scroll-box" />
      </div>
    </main>
  );
};
